...
function JekyGlobalData:GetSummitValue()  return PS.Config.Get("SummitValue") or 5    end
function JekyGlobalData:GetApexValue()    return PS.Config.Get("ApexValue")   or 50 end
